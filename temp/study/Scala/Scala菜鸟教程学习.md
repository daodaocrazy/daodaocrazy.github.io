...
编译后我们可以看到目录下生成了 HelloWorld.class 文件，**该文件可以在Java Virtual Machine (JVM)上运行**。编译后，我们可以使用以下命令来执行程序：(试了下`scala HelloWorld# Scala菜鸟教程学习
...
编译后我们可以看到目录下生成了 HelloWorld.class 文件，**该文件可以在Java Virtual Machine (JVM)上运行**。编译后，我们可以使用以下命令来执行程序：(试了下会报错)
